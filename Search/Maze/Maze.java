...
*/
/**
* Class Maze. Representing search space as a 
* two-locational maze
*/
public class Maze{
	...
	/**
	* The maze or search space data is stored as
	* a short integer rather than as a boolean
	* so that bred-first style searches can use the
	* array to store search depth. A value of -1
	* indicates a barrier in the maze.
	*/
	private short [][] maze;
	...
	public Maze(int width, int height){
		...
		/**
		* Randomize the maze by putting up arbitrary
		* obsticals
		*/
