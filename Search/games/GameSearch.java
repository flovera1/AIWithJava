...
public abstract class GameSearch {
    ...
    protected Vector alphaBetaHelper(int depth, Position p,
        ...
        if (reachedMaxDepth(p, depth)) {
            /**
            * In min-max search the evaluation work is done
            * while backing up.
            * the search proceeds to a leaf node, and then
            * return a vector for the leaf. its first 
            * coordinate is the position evaluation of the
            * position at the leaf node, the second element
            * of the vector is the board position at the
            * the leaf node.
            */
